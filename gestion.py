...
# =============================================================
    ...
    with st.expander("➕ ALTA DE NUEVO PROVEEDOR", expanded=False):
        with st.form("f_prov", clear_on_submit=True):
            ...
            cuenta  = c1.selectbox("Cuenta de Gastos", ["COMBUSTIBLE", "REPARACION", "REPUESTO", "SERVICIO LUZ, GAS", "ALQUILERES", "COMPRA ART. LIMPIEZA", "PUBLICIDAD", "GASTOS OFICINA", "GASTOS EN LIBRERIA", "CHOFERES EVENTUALES", "VARIOS"])
