    ...
    <body>
        <div class="main-border">
            ...
            <div class="leyenda-box">
                ...
                En caso de que la empresa tenga que hacerse responsable de los mismos, el presente presupuesto deberá ser reformulado.
            </div>
...
if sel == "CALENDARIO":
                ...
                if st.session_state.get(f"edit_p_mode_{i}", False):
                    with st.form(f"f_edit_p_{i}"):
                        ...
                        if st.form_submit_button("✅ Guardar"):
                            ...
                            guardar_datos("proveedores", st.session_state.proveedores)
                            st.session_state[f"edit_p_mode_{i}"] = False
                            st.rerun()
            st.divider()
    ...
    with st.form("f_gasto", clear_on_submit=True):
        ...
        # Se asocia el IVA correspondiente a cada neto antes de sumar retenciones y no gravados
