    ...
    with t3:
        ...
        with st.form("f_cob"):
            ...
            if st.form_submit_button("GENERAR COBRANZA"):
                # REPARACIÓN: Guardar en dataframes primero
                ...
                # REPARACIÓN: GUARDAR ANTES DEL RERUN [cite: 1, 114]
                ...
                st.rerun() # Ahora el rerun ocurre después de asegurar el guardado [cite: 1, 115]
